            ...
            {logos.map((logoUrl) =>
              logoUrl.startsWith('data:image/svg') ? (
                ...
                <div key={logoUrl} className="flex flex-col items-center gap-2">
                  <div
                    className="rounded-xl bg-white p-4 max-h-24 max-w-[180px] overflow-hidden flex items-center justify-center [&_svg]:max-h-16 [&_svg]:max-w-[140px] [&_svg]:h-auto [&_svg]:w-auto"
